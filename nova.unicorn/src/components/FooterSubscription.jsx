    ...
    <div className="w-full lg:w-[80%] 2xl:w-[75%] ">
      <div className="hidden lg:grid lg:grid-cols-4 gap-3 py-6">
        ...
        <div className="text-sm text-white col-span-2 ">
          <h1 className="font-semibold uppercase">New to Unicorn?</h1>
          ...
          <div className="flex mt-6">
            <div className="flex items-center justify-center cursor-pointer hover:bg-black/10 rounded-[50%] p-2 h-fit ml-[-7px] mr-1">
              {isClicked ? (
                <IoMdCheckbox
