...
const AdminVendors = () => {
  ...
  return <main className="min-h-screen bg-[#eef3f1] px-4 py-8 sm:px-6 lg:px-10"><div className="mx-auto max-w-7xl">
    <section className="relative overflow-hidden rounded-[2rem] bg-[#123d3a] px-6 py-9 text-white shadow-xl sm:px-10"><div className="absolute -right-16 -top-24 h-64 w-64 rounded-full border-[36px] border-emerald-300/20" /><div className="relative flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between"><div><p className="text-xs font-bold uppercase tracking-[0.3em] text-emerald-200">Nova operations desk</p><h1 className="mt-3 max-w-2xl text-4xl font-black sm:text-5xl">Trust, reviewed with care.</h1><p className="mt-4 max-w-xl text-sm leading-6 text-emerald-50/75">Approve sellers, inspect submitted evidence, and keep every verification decision visible.</p></div><Link to="/login" className="inline-flex shrink-0 items-center justify-center rounded-xl border border-white/20 bg-white/10 px-4 py-3 text-sm font-bold text-white hover:bg-white/20">Login page</Link></div></section>
