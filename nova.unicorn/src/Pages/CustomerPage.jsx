    ...
    <main className="min-h-screen bg-[#02070d] text-[#f3f5f7]">
      <header className="bg-[#0b0c0d] shadow-[0_4px_0_rgba(196,200,204,0.22)]">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-4 text-white sm:px-6 lg:px-8">
          ...
          <div className="flex justify-end"><Link to={user ? "/account" : "/login"} className="flex items-center gap-3 text-sm font-black uppercase text-[#f3f5f7]"><FiUser className="text-2xl" /><span>{user?.username || "My account"}</span></Link></div>
